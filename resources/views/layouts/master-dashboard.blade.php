        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{route('manual')}}" class="nav-link">Panduan Pengguna</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item d-sm-inline-block dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item text-xs" style="font-weight: bold;">{{Auth::user()->username}}</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item text-xs" href="{{route('user.edit', ['user' => Auth::user()->id])}}">Ubah Password</a>
                        <div class="dropdown-divider"></div>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{route('tender.index')}}" class="nav-link @yield('active-tender')">
                                <i class="nav-icon fas fa-cog fa-spin fa-xs" style="--fa-animation-duration: 1s;"></i>
                                <p>
                                    Informasi Pekerjaan
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{route('rincian.all')}}" class="nav-link @yield('active-rincian')">
                                <i class="nav-icon fas fa-receipt fa-xs"></i>
                                <p>
                                    Rincian Harga
                                </p>
                            </a>
                        ...
                        <li class="nav-item @yield('menuopen')">
                            <a href="#" class="nav-link @yield('action')">
                            ...
                            <ul class="nav nav-treeview ml-4">
                                <li class="nav-item">
                                    <a href="{{route('vendor.index')}}" class="nav-link @yield('active-vendor')">
                            ...
                            <ul class="nav nav-treeview ml-4">
                                <li class="nav-item">
                                    <a href="{{route('bagian.index')}}" class="nav-link @yield('active-bagian')">
                        ...
                        <li class="nav-item">
                            <a href="{{route('user.log')}}" class="nav-link @yield('active-log')">
                                <i class="nav-icon fas fa-history fa-xs"></i>
                                <p>
                                    Activity Log
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{route('tender.trash')}}" class="nav-link @yield('active-trash')">
                                <i class="nav-icon fas fa-trash fa-xs"></i>
                                <p>
                                    Trash
                                </p>
                                <span class="badge badge-danger right">{{$trashed}}</span>
                            </a>
                        </li>
                        @endrole
                        @role('Admin')
                        <li class="nav-header text-white">ADMIN</li>
                        <li class="nav-item">
                            <a href="{{route('user.index')}}" class="nav-link @yield('active-user')">
                                <i class="nav-icon fas fa-user fa-xs"></i>
                                <p>
                                    Pengguna Sistem
                                </p>
                            </a>
