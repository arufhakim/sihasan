                        ...
                        <form action="{{route('logon')}}" method="post">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12 mb-1">
                                    ...
                                    <input type="text" class="form-control @error('username') is-invalid @enderror" value="{{old('username')}}" id="username" name="username" placeholder="Username" style="font-size: 12px; height: 40px">
                                    @error('username')
