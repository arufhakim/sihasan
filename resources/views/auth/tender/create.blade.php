        ...
        <div class="card-body">
            <form action="{{route('tender.store')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm @error('no_sp') is-invalid @enderror" value="{{old('no_sp')}}" id="no_sp" name="no_sp" placeholder="Cont. 0169/B/HK.01.02/35/SP/2022;0170/B/HK.01.02/35/SP/2022">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm @error('no_agreement') is-invalid @enderror" value="{{old('no_agreement')}}" id="no_agreement" name="no_agreement" placeholder="Cont. 4100003840;4100003841">
                    <span style="font-size: smaller;"> Input lebih dari satu pisahkan dengan tanda <b>Titik Koma</b> ( ; )</span>
                    @error('no_agreement')
                    <div class="invalid-feedback">
                        {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group" data-target-input="nearest">
                        <input type="text" class="form-control form-control-sm @error('prosentase') is-invalid @enderror" value="{{old('prosentase')}}" id="prosentase" name="prosentase" placeholder="Cont. 80;20">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group date" id="reservationdate_add" data-target-input="nearest">
                            <input type="text" class="form-control form-control-sm datetimepicker-input @error('periode_awal') is-invalid @enderror" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask value="{{old('periode_awal')}}" data-target="#reservationdate_add" placeholder="Periode Awal" name="periode_awal">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group date" id="reservationdate_add_2" data-target-input="nearest">
                            <input type="text" class="form-control form-control-sm datetimepicker-input @error('periode_akhir') is-invalid @enderror" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask value="{{old('periode_akhir')}}" data-target="#reservationdate_add_2" placeholder="Periode Akhir" name="periode_akhir">
                ...
                <div class="form-group">
                    ...
                    <textarea id="summernote" class="form-control form-control-sm @error('keterangan') is-invalid @enderror" name="keterangan" rows="3" cols="50" placeholder="Keterangan">{{old('keterangan')}}</textarea>
                    @error('keterangan')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
