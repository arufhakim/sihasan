...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Edit Rincian</li>
</ol>
@endsection
@section('dashboard')
<div>
    <div class="card">
        <div class="card-header card-forestgreen">
            <h6 class="card-title">Edit Rincian</h6>
            <!-- tool -->
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('pekerjaan') is-invalid @enderror" value="{{old('pekerjaan') ?? $pekerjaan->pekerjaan}}" id="pekerjaan" name="pekerjaan" placeholder="Nama Pekerjaan">
                            @error('pekerjaan')
                    ...
                    <div class="col-md-2 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('volume') is-invalid @enderror" value="{{old('volume') ?? $pekerjaan->volume}}" id="volume" name="volume" placeholder="Volume">
                            @error('volume')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-2 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('satuan') is-invalid @enderror" value="{{old('satuan') ?? $pekerjaan->satuan}}" id="satuan" name="satuan" placeholder="Satuan">
                            @error('satuan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm @error('harga') is-invalid @enderror" value="{{old('harga') ?? $pekerjaan->harga}}" id="harga" name="harga" placeholder="Harga">
                            @error('harga')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
